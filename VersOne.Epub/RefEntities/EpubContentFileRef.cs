...
namespace VersOne.Epub
{
    ...
    public abstract class EpubContentFileRef
    {
        ...
        /// <summary>
        ///     Opens the referenced file and writes content of the <paramref name="html"/>. 
        /// </summary>
        /// <param name="contentStream"></param>
        /// <param name="html">Content to write.</param>
        public void SetContent(Stream contentStream, string html)
        {
            try
            {
